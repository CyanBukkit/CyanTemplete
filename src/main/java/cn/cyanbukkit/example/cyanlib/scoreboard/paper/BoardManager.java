package cn.cyanbukkit.example.cyanlib.scoreboard.paper;
...
import cn.cyanbukkit.example.cyanlib.scoreboard.paper.base.impl.AdventureBoard;
import cn.cyanbukkit.example.cyanlib.scoreboard.paper.base.impl.LegacyBoard;
...
public final class BoardManager {
	...
	private Integer updateTaskId = null;
	private final Map<UUID, BoardBase<?>> boards = new HashMap<>();
	...
	private long updateInterval = 3L; // in ticks
	private BoardManager(Plugin plugin) {
		this.plugin = plugin;
	}
	 ...
	 */
	public <T> BoardBase<T> getBoard(UUID uuid) throws ClassCastException {
